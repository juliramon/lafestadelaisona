	...
	return (
		...
		>
			<div className="flex-auto md:w-1/3 relative flex items-center justify-start">
				<button
					type="button"
					className="text-sm inline-flex items-center tracking-widest nav__menu-button text-primary-500"
					...
					<ul>
						<li>
							<a
								href="/#introduccio"
								title="Introducció"
								className="text-white py-2.5 block px-4 bg-primary-500 hover:bg-primary-400 transition-all duration-300 ease-in-out"
								onClick={() => setOpenMenu(!openMenu)}
							>
								Introducció
							</a>
			...
			<div className="flex-auto md:w-1/3 text-center flex justify-end md:justify-center">
				<a
					href="/"
					title="La festa de la Isona"
					className="text-xl md:text-2xl font-tenez inline-flex items-center justify-center"
				>
					<span>La festa de la Isona 🎉</span>
				</a>
			</div>
